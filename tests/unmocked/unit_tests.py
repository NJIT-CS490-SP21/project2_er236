...
class app(unittest.TestCase):
    def setUp(self):
        self.success_test = {
            "connect":[
                #new socket connects
                {"sid":"3ihsmcbksjojw", "exist":False},
                #same socket tried to connect a second time
                {"sid":"3ihsmcbksjojw", "exist":True},
            ],
            "disconnect":[
                #Spectator takes over player 1
                {"remove": "3ihsmcbksjojw", "newPlayer":"Mario2brothers", "newId":0},
                #player takes over player 2
                {"remove":"3ihsmcbksjojoooo", "newPlayer":"Fire_Dragon_God_Slayer", "newId":1}]
        }
